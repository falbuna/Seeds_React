...
function About(){
    ...
    <div class="py-16 bg-green1 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-base max-w-prose mx-auto lg:max-w-none">
            <p class="text-base leading-6 text-white font-semibold tracking-wide uppercase">Happiness</p>
            <h1 class="mt-2 mb-8 text-3xl leading-8 font-extrabold tracking-tight text-lime1 sm:text-4xl sm:leading-10">
        ...
        <div class="relative z-10 text-base max-w-prose mx-auto mb-8 lg:max-w-5xl lg:mx-0 lg:pr-72">
            <p class="text-lg text-white leading-7">Seeds is designed to help people be more happy by teaching them to
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
            <div class="relative z-10 mb-12 lg:mb-0">
                <div class="mb-10 prose text-white mx-auto lg:max-w-none text-lg text-white leading-7">
                ...
                <svg class="absolute top-0 right-0 -mt-20 -mr-20 lg:top-auto lg:right-auto lg:bottom-1/2 lg:left-1/2 lg:mt-0 lg:mr-0 xl:top-0 xl:right-0 xl:-mt-20 xl:-mr-20"
                 ...
                 {/* <blockquote class="relative bg-white rounded-lg shadow-lg">
                    <div class="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                        <img src="/public/assets/images/seedsLogo.png" alt="Workcation" class="h-8"></img>
                        <div class="relative text-lg text-green1 leading-7 font-medium mt-8">
                            <svg class="absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-white"
                                fill="currentColor" viewBox="0 0 32 32">
                                <path
                                    d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
                            </svg>
                            <p class="relative">But, in reality, being unhappy might also teach him something about
                                happiness.</p>
                        </div>
                    </div>
                    <cite
                        class="flex items-center sm:items-start bg-lime1 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                        <div class="rounded-full border-2 border-white mr-4 sm:-mt-15 sm:mr-6">
                            <img class="w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-indigo-300"
                                src="/public/assets/images/hector.png" alt=""></img>
                        </div>
                        <span class="text-white font-semibold leading-6">
                            <strong class="text-green1 font-semibold">François Lelord :</strong>
                            <br class="sm:hidden">
...
<div class="py-8 bg-green1 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">

        <h1 class="mt-2 mb-2 text-3xl leading-8 font-extrabold tracking-tight text-lime1 sm:text-4xl sm:leading-10">
            How can this information help us be happier?
        </h1>
        <p class="text-lg text-white leading-7">As humans sometimes it is difficult to analyze our feelings.
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        ...
        <p class="text-lg text-white leading-7">While it can seem silly, taking the time to look for a good
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        ...
        <p class="text-lg text-white leading-7">We truly hope Seeds helps you make steps towards cultivating
    ...
    <div class="py-2 bg-green1 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex text-base max-w-prose mx-auto lg:max-w-none">
                <div class="rounded-md shadow">
                    <a href="https://www.mhanational.org/"
                        class="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-lime1 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition duration-150 ease-in-out">
                        Learn More!
                    </a>
                </div>
                <div class="rounded-md shadow ml-4">
                    <a href="http://www.camh.ca/"
                        class="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-lime1 bg-white hover:text-lime1 focus:outline-none focus:border-indigo-300 focus:shadow-outline-indigo transition duration-150 ease-in-out">
                        Visit CAMH
                    </a>
                </div>
            </div>
